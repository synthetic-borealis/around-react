...
function AddPlacePopup(props) {
  ...
  return (
    <PopupWithForm name="add" title="New place" buttonCaption="Create" isOpen={props.isOpen}
      onClose={props.onClose} onSubmit={handleSubmit}>
      <label className="form__field">
        <input id="place-title-input" type="text" placeholder="Title" name="name" required
          className="form__input form__input_type_place-title" minLength="1" maxLength="30" onChange={handleChange} />
      ...
      <label className="form__field">
        <input id="place-link-input" type="url" placeholder="Image Link" name="link" required
          className="form__input form__input_type_place-link" onChange={handleChange} />
